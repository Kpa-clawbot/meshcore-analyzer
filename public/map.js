    ...
    return `
      <div class="map-popup" style="font-family:var(--font);min-width:180px;">
        ...
        <div style="margin-top:8px;clear:both;">
          ...
          ${node.public_key ? ` · <a href="#" data-show-neighbors data-pubkey="${safeEsc(node.public_key)}" data-name="${safeEsc(node.name || 'Unknown')}" style="color:var(--accent);font-size:12px;">Show Neighbors</a>` : ''}
        </div>
      </div>`;
  }
